...
class LoopCloudKitUtility {
    ...
    static func addLoop(loop: Loop) {
        ...
        loopRecord["isDreamJournal"] = loop.isDream as CKRecordValue?
        loopRecord["isAffirmation"] = loop.isAffirmation as CKRecordValue?
        loopRecord["isMorningJournal"] = loop.isMorningJournal as CKRecordValue?
